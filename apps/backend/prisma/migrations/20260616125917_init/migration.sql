...
-- CreateIndex
CREATE INDEX "SalesItem_soId_idx" ON "SalesItem"("soId");
...
-- CreateIndex
CREATE INDEX "Payment_soId_idx" ON "Payment"("soId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Payroll_companyId_employeeId_month_key" ON "Payroll"("companyId", "employeeId", "month");
...
-- AddForeignKey
ALTER TABLE "PurchaseItem" ADD CONSTRAINT "PurchaseItem_poId_fkey" FOREIGN KEY ("poId") REFERENCES "PurchaseOrder"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SalesItem" ADD CONSTRAINT "SalesItem_soId_fkey" FOREIGN KEY ("soId") REFERENCES "SalesOrder"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Invoice" ADD CONSTRAINT "Invoice_soId_fkey" FOREIGN KEY ("soId") REFERENCES "SalesOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_soId_fkey" FOREIGN KEY ("soId") REFERENCES "SalesOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
